...
czas_druciaka_na_gorze = 125;  //2 sekundy dla druciaka na gorze aby dolek zrobil git
...
while (1)
      ...
      1)              if(cykl_sterownik_1 < 5 & krazek_scierny_cykl_po_okregu < krazek_scierny_cykl_po_okregu_ilosc &  wykonalem_komplet_okregow == 0 & (ruch_pietrowy == 0 | ruch_pietrowy == 2)
        ...
        1)            if(cykl_sterownik_3 < 5 & abs_ster3 == 0 & ruch_pietrowy == 1)
                  ...
                  if(cykl_sterownik_4 == 5 & powrot_przedwczesny_druciak == 1)
                   ...
                   //////////////////////////////////////////////     
                    ...
                    if(cykl_sterownik_1 == 5 & wykonalem_komplet_okregow == 1 &
                       ...
                       cykl_sterownik_3 == 5 & cykl_sterownik_4 == 5 & powrot_przedwczesny_druciak == 0)                                
                        {
                        powrot_przedwczesny_druciak = 0;
                        cykl_sterownik_1 = 0;
                        cykl_sterownik_2 = 0;
