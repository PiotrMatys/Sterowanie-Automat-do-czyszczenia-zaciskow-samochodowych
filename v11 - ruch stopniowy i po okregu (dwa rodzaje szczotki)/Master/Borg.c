...
delay_ms(1000);
PORTB.4 = 1;  //przedmuchy teraz ciagle jak jedzie
...
PORTB.4 = 0;  //przedmuchy teraz ciagle jak jedzie
delay_ms(1000);
...
while (1)
      ...
      while((start == 1 & il_zaciskow_rzad_1 > 1 & il_zaciskow_rzad_2 != 1 & macierz_zaciskow[1]!=0  & (macierz_zaciskow[2]!=0 |  il_zaciskow_rzad_2 == 0)) | jestem_w_trakcie_czyszczenia_calosci == 1)
            ...
            case 3:
                    ...
                    if(cykl_sterownik_4 == 5 & szczotka_druc_cykl < szczotka_druciana_ilosc_cykli+1)
                        {
                        szczotka_druc_cykl++;
                        cykl_sterownik_4 = 0;
                        
                        if(szczotka_druc_cykl == szczotka_druciana_ilosc_cykli+1)
                            {
                            if(rzad_obrabiany == 1)
                             {
                             while(sprawdz_pin0(PORTMM,0x77) == 1)
