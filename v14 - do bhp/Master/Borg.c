...
//sprawdz_pin2(PORTMM,0x77) przycisk zatrzymaj    
...
//PORTE.5  IN5  STEROWNIK4      ///////////////////////////////////////////////////////////////////tu zmieniam 16.04 - cewka zmiany przedmuch 0 - ta na krazku 1- ta na druciaku
      ...
      while((start == 1 & il_zaciskow_rzad_1 > 1 & il_zaciskow_rzad_2 != 1 & macierz_zaciskow[1]!=0  & (macierz_zaciskow[2]!=0 |  il_zaciskow_rzad_2 == 0)) | jestem_w_trakcie_czyszczenia_calosci == 1)
            ...
            case 0:
                    ...
                    if(jestem_w_trakcie_czyszczenia_calosci == 0)
                        ...
                        szczotka_druciana_ilosc_cykli = 1; //zmieniam bo teraz inny ruch szczotki drucianej, jeden schoek na dole
                                                //2090
            ...
            case 2:
                    ...
                    if(cykl_sterownik_4 == 5)
                        {
                        PORTE.2 = 1;  //wlacz szlifierke   wylaczam do testu
                        cykl_sterownik_4 = 0;
                        sek13 = 0;   
                        cykl_glowny = 3;     
                        }
