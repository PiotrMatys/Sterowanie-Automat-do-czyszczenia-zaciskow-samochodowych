...
if(rzad == 1 & na_plus_minus == 1)
    ...
    komunikat_na_panel("Kly w kierunku prawej strony",adres2,adres22);
    }
...
if(rzad == 1 & na_plus_minus == 0)
    ...
    komunikat_na_panel("Kly w kierunku lewej strony",adres2,adres22);
    }
...
//PORTE.5  IN5  STEROWNIK4   ///////////////////////////////////////////////teraz tu bêdzie przedmuch kana³ B 
...
//wartosc_parametru_panelu(1,96,48);
//wartosc_parametru_panelu(2,96,64);
//wartosc_parametru_panelu(3,96,80);
//wartosc_parametru_panelu(4,96,96);
//wartosc_parametru_panelu(5,96,112);
...
wartosc_parametru_panelu(0,128,64);   //to do statystyki, zeby zawsze bylo 0
...
if(czas_pracy_szczotki_drucianej_h >= czas_pracy_szczotki_drucianej_stala)
     ...
     komunikat_na_panel("Wymien szczotke druciana",80,0);
     }
            ...
            case 17:
                                 ...
                                 if(cykl_sterownik_2 < 5)                                //ster 1 do 0
                                    ...
                                    if(cykl_sterownik_1 == 5 & cykl_sterownik_2 == 5)
                                        ...
                                        komunikat_na_panel("                                                ",adr1,adr2);
                                        komunikat_na_panel("Wczytaj zacisk ten sam lub nowy",adr1,adr2);
                                        komunikat_na_panel("                                                ",adr3,adr4);
                                        komunikat_na_panel("Wczytaj zacisk ten sam lub nowy",adr3,adr4);
                                        }
