...
//sprawdz_pin6(PORTMM,0x77) ALARM STEROWNIK4      chyba na odwrot
...
while(g == 1)
    ...
    case 3:
            ...
            //na sam dol zjezdzamy pionami
                ...
                if(cykl_sterownik_4 < 5)
                    cykl_sterownik_4 = sterownik_4_praca(0x02);  //do pozycji wymiany
...
while (1)
     ...
     //jak zle wczyta takiego co go nie ma to dac ilosc zaciskow = 0 w tym rzedzie
      ...
      while((start == 1 & il_zaciskow_rzad_1 > 1 & il_zaciskow_rzad_2 != 1 & macierz_zaciskow[1]!=0  & (macierz_zaciskow[2]!=0 |  il_zaciskow_rzad_2 == 0)) | jestem_w_trakcie_czyszczenia_calosci == 1)
            ...
            case 2:
                    ...
                    if(cykl_sterownik_4 < 5)
                        //cykl_sterownik_4 = sterownik_4_praca(1,0,0,0,1,0);  //ABS  //tu blad w arkuszu exela
