...
*/
                                                     ...
                                                     //2
if(wejscie_krazka_sciernego_w_pow_boczna_cylindra == 1)
    {  
    }

                                                   //2
if(wejscie_krazka_sciernego_w_pow_boczna_cylindra == 2)
    {
    a[5] = a[5] + 0x10;   //plus 16 dzesietnie
    a[6] = a[5]+0x001;  //okrag
    a[8] = a[6]+0x001;  //-delta okrag  
                                                    ...
                                                    //1
if(wejscie_krazka_sciernego_w_pow_boczna_cylindra == 3)
    {
    a[5] = a[5] + 0x20;   //plus 32 dzesietnie
    a[6] = a[5]+0x001;  //okrag
    a[8] = a[6]+0x001;  //-delta okrag  
                                                    ...
                                                    //2
if(wejscie_krazka_sciernego_w_pow_boczna_cylindra == 4)
    {
    a[5] = a[5] + 0x30;   //plus 48 dzesietnie
    a[6] = a[5]+0x001;  //okrag
    a[8] = a[6]+0x001;  //-delta okrag    
...
while (1)
      ...
      while((start == 1 & il_zaciskow_rzad_1 > 1 & il_zaciskow_rzad_2 != 1 & macierz_zaciskow[1]!=0  & (macierz_zaciskow[2]!=0 |  il_zaciskow_rzad_2 == 0)) | jestem_w_trakcie_czyszczenia_calosci == 1)
           ...
           case 7:
                    ...
                    if(cykl_sterownik_1 == 0 | krazek_scierny_cykl_po_okregu_ilosc == 0)
                        {
                   ...
                   //////////////////////////////////////////////     
                    ...
                    if((wykonalem_komplet_okregow == 4 &
                       szczotka_druc_cykl == szczotka_druciana_ilosc_cykli &
                        cykl_sterownik_4 == 5 & powrot_przedwczesny_druciak == 0) | (wykonalem_komplet_okregow == 4 & koniec_rzedu_10 == 1) )                                
                        {
                        powrot_przedwczesny_druciak = 0;
                        cykl_sterownik_1 = 0;
                        cykl_sterownik_2 = 0;
